...
const ReviewCard = ({review}:Props) => {
  ...
  return <div className='rounded-md overflow-hidden bg-[#140c1c] m-4 h-full flex flex-col justify-between'>
    <div className='p-6'>
    ...
    <div className='px-6 py-3 mb-3 w-fit mx-auto rounded-full flex items-center space-x-3 bg-indigo-800 text-white font-bold'>
      <span>{rating}/5</span>
